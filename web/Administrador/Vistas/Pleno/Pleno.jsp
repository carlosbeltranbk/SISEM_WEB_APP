                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Integrantes del pleno registrados</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaPlenos" status="stat" var="lista">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-success" href="<%=context%>/consultarPlenoId?beanPleno.persona.idPersona=<s:property value="persona.idPersona"/>">Modificar</a>
                                                    </td>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
