                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="modificarPleno" method="POST">
                                        <div class="form-row">

                                            <input  value="<s:property value="beanPleno.persona.idPersona"/>" type="hidden" class="form-control" name="beanPleno.persona.idPersona" />
                                            
                                            <div class="form-group col-md-6">

                                                <label for="rol">Rol: </label>
                                                <s:set value="beanPleno.rol.idRol" var="idRol"/>
                                                <select disabled class="form-control" name="beanPleno.rol.idRol">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input value="<s:property value="beanPleno.persona.nombre"/>" type="text" class="form-control" id="nombre" name="beanPleno.persona.nombre" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="primeroApellido">Apellido Paterno: </label>
                                                <input value="<s:property value="beanPleno.persona.primeroApellido"/>" type="text" class="form-control" id="primeroApellido" name="beanPleno.persona.primeroApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="segundoApellido">Apellido Materno: </label>
                                                <input value="<s:property value="beanPleno.persona.segundoApellido"/>" type="text" class="form-control" id="segundoApellido" name="beanPleno.persona.segundoApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="fechaNacimiento">Fecha de Nacimineto: </label>
                                                <input title="Debes ser mayor de edad" required data-date-format="aaaa/mm/dd" min="1000-01-01" max="2001-12-31" value="<s:property value="beanPleno.persona.fechaNacimiento"/>" type="date" class="form-control" id="fechaNacimiento" name="beanPleno.persona.fechaNacimiento" >
                                               
                                            </div>

                                            <div  class="form-group col-md-3">
                                                <label for="edad">Edad: </label>
                                                <input value="<s:property value="beanPleno.persona.edad"/>" type="text" disabled class="form-control" id="edad" name="beanPleno.persona.edad" >                             
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="curp">Curp: </label>
                                                <input value="<s:property value="beanPleno.persona.curp"/>" type="text" class="form-control" id="curp" name="beanPleno.persona.curp" >

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="numeroTrabajador">Número de trabajador  </label>
                                                <input value="<s:property value="beanPleno.persona.numeroTrabajador"/>"  class="form-control" id="numeroTrabajador" name="beanPleno.persona.numeroTrabajador" >
                                            </div>

                                            <div class="form-group col-md-6">

                                                <label for="municipio">Municipio: </label>
                                                <s:set value="beanPleno.municipio.idMunicipio" var="idMunicipio"/>
                                                <select class="form-control" name="beanPleno.municipio.idMunicipio">
