                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Secretaría de Acuerdos a modificar:</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="modificarAcuerdo" method="POST">
                                        <div class="form-row">

                                            <input  value="<s:property value="beanAcuerdo.persona.idPersona"/>" type="hidden" class="form-control" name="beanAcuerdo.persona.idPersona" />
                                            
                                            <div class="form-group col-md-6">

                                                <label for="rol">Rol: </label>
                                                <s:set value="beanAcuerdo.rol.idRol" var="idRol"/>
                                                <select disabled class="form-control" name="beanAcuerdo.rol.idRol">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input value="<s:property value="beanAcuerdo.persona.nombre"/>" type="text" class="form-control" id="nombre" name="beanAcuerdo.persona.nombre" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="primeroApellido">Apellido Paterno: </label>
                                                <input value="<s:property value="beanAcuerdo.persona.primeroApellido"/>" type="text" class="form-control" id="primeroApellido" name="beanAcuerdo.persona.primeroApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="segundoApellido">Apellido Materno: </label>
                                                <input value="<s:property value="beanAcuerdo.persona.segundoApellido"/>" type="text" class="form-control" id="segundoApellido" name="beanAcuerdo.persona.segundoApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="fechaNacimiento">Fecha de Nacimineto: </label>
                                                <input title="Debes ser mayor de edad" required data-date-format="aaaa/mm/dd" min="1000-01-01" max="2001-12-31" value="<s:property value="beanAcuerdo.persona.fechaNacimiento"/>" type="date" class="form-control" id="fechaNacimiento" name="beanAcuerdo.persona.fechaNacimiento" >
                                               
                                            </div>

                                            <div  class="form-group col-md-3">
                                                <label for="edad">Edad: </label>
                                                <input value="<s:property value="beanAcuerdo.persona.edad"/>" type="text" disabled class="form-control" id="edad" name="beanAcuerdo.persona.edad" >                             
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="curp">Curp: </label>
                                                <input value="<s:property value="beanAcuerdo.persona.curp"/>" type="text" class="form-control" id="curp" name="beanAcuerdo.persona.curp" >

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="numeroTrabajador">Número de trabajador  </label>
                                                <input value="<s:property value="beanAcuerdo.persona.numeroTrabajador"/>"  class="form-control" id="numeroTrabajador" name="beanAcuerdo.persona.numeroTrabajador" >
                                            </div>

                                            <div class="form-group col-md-6">

                                                <label for="municipio">Municipio: </label>
                                                <s:set value="beanAcuerdo.municipio.idMunicipio" var="idMunicipio"/>
                                                <select class="form-control" name="beanAcuerdo.municipio.idMunicipio">
