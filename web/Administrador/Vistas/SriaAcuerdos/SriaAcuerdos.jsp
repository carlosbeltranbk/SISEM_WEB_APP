                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaAcuerdos" status="stat" var="lista">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-success" href="<%=context%>/consultarAcuerdoId?beanAcuerdo.persona.idPersona=<s:property value="persona.idPersona"/>">Modificar</a>
                                                    </td>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
