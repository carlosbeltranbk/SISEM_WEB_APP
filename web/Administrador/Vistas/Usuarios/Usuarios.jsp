    ...
    <body id="page-top">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="datos" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaUsuarios" status="stat" var="lista">
                                                <tr>
                                                    <td><s:property value="#stat.count"/></td>
                                                    <td><s:property value="correo"/></td>

                                                    <td><s:property value="persona.nombre"/></td>
                                                    <td><s:property value="persona.primeroApellido"/></td>
                                                    <td><s:property value="persona.segundoApellido"/></td>
                                                    <td><s:property value="rol.nombreRol"/></td>

                                                    <s:set value="estado" var="est"/>
                                                    <s:if test="%{#est == true}">
                                                        <td>Activo</td>
                                                    </s:if>
                                                    <s:if test="%{#est == false}">
                                                    ...
                                                    <td>
                                                        <form action="eliminarUsuario" method="POST">
                                                            <input type="hidden" name="BeanUsuario.idUsuario" value="<s:property value="idUsuario"/>">
                                                            <button onclick="return confirmarBajaLogica()" type="submit" class="btn btn-outline-warning">Deshabilitar</button>
                                                        </form>
                                                    </td>

                                                    <td>
                                                        <a class="btn btn-outline-success" href="<%=context%>/consultarUsuarioId?BeanUsuario.idUsuario=<s:property value="idUsuario"/>">Modificar</a>
                                                    </td>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
        ...
        <script>
                                                    ...
                                                    $("#btnSA_3").click(function () {
                                                        swal({
                                                            title: "¡Cuidado!",
                                                            text: "¿Está seguro de deshabilitar al usuario?",
                                                            icon: "warning",
                                                            buttons: true,
                                                            dangerMode: true,
                                                        })
