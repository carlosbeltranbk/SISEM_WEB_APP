                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="registrarUsuarioPersonaAdmin" method="POST" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                <label for="inputEmail4">Nombre:</label>
                                                <input required type="text" class="form-control form-control-user" name="BeanUsuario.persona.nombre" id=""  placeholder="nombre(s)..." title="Únicamente letras">
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="inputEmail4">Primer Apellido:</label>
                                                <input required type="text" class="form-control form-control-user" name="BeanUsuario.persona.primeroApellido" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="apellido paterno..." title="Únicamente letras" >

                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="inputEmail4">Segundo Apellido:</label>
                                                <input required type="text" class="form-control form-control-user" name="BeanUsuario.persona.segundoApellido" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="apellido materno..." title="Únicamente letras" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="inputEmail4">Fecha de Nacimiento</label>
                                                <input title="Debes ser mayor de edad" required data-date-format="aaaa/mm/dd" min="1000-01-01" max="2001-12-31" type="date" class="form-control form-control-user" name="BeanUsuario.persona.fechaNacimiento" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingresa tu Fecha de Nacimiento...">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input required type="email" class="form-control form-control-user" name="BeanUsuario.correo" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingresa tu correo electronico...">
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Rol a asignar:</label>
                                                <select id="selectValue" onchange="ocultarInput();" required class="form-control" name="BeanUsuario.rol.idRol">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="inputEmail4">Número de trabajador:</label>
                                                <input required id="inputOcultar" type="number" min="1" MAX="9999" onkeypress="return justNumbers(event);" class="form-control form-control-user" name="BeanUsuario.persona.numeroTrabajador"  placeholder="Numero de trabajador...">
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                <input onclick="return confirmarRegistrar()" type="submit" value="Registrar" class="btn btn-outline-success btn-user btn-block">
                                            </div>
                                        </div>  
                                    </form>
                                </div>
