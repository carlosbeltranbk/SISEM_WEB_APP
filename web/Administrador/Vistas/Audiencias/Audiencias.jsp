                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Audiencias Registradas</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaAudiencias" status="stat" var="lista">
                                                <tr>
                                                <td><s:property value="#stat.count"/></td>
                                                <td><s:property value="dia"/></td>
                                                <td><s:property value="hora"/></td>
                                                <td><s:property value="usuario.correo"/></td>
                                                <td><s:property value="demanda.tipoDemanda"/></td>                  
                                            </tr>
                                            </s:iterator>
                                        </tbody>
