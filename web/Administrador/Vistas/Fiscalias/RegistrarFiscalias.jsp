                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Fiscalia a registrar:</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="registrarFiscalia" method="POST">
                                        <div class="form-row">

                                            <div class="form-group col-md-3">
                                                <label for="nombreFiscalia">Nombre de la fiscalía: </label>
                                                <input  required type="text" class="form-control" id="nombreFiscalia" name="BeanFiscalia.nombreFiscalia" title="Únicamente letras">
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="direccionFiscalia">Dirección: </label>
                                                <input  required type="text" class="form-control" id="direccionFiscalia" name="BeanFiscalia.direccionFiscalia" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="municipio">Municipio: </label>
                                                <select required class="form-control" name="BeanFiscalia.municipio.idMunicipio">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="persona">Persona en cargo: </label>
                                                <select required class="form-control" name="BeanFiscalia.persona.idPersona">
                                                    <option value="">Seleccione...</option>
                                            ...
                                            <br>
                                            <div class="form-group col-md-6">
                                                <input onclick="return confirmarRegistrar()" type="submit" class="btn btn-success" value="Registrar" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
