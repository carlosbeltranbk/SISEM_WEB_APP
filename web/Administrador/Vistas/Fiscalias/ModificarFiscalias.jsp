                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Fiscalia a modificar:</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="modificarFiscalia" method="POST">
                                        <div class="form-row">

                                            <input  value="<s:property value="BeanFiscalia.idFiscalia"/>" type="hidden" class="form-control" name="BeanFiscalia.idFiscalia" />
                                            <div class="form-group col-md-3">
                                                <label for="nombreFiscalia">Nombre de la fiscalia: </label>
                                                <input value="<s:property value="BeanFiscalia.nombreFiscalia"/>" type="text" class="form-control" id="nombreFiscalia" name="BeanFiscalia.nombreFiscalia" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="direccionFiscalia">Dirección: </label>
                                                <input value="<s:property value="BeanFiscalia.direccionFiscalia"/>" type="text" class="form-control" id="direccionFiscalia" name="BeanFiscalia.direccionFiscalia" >
                                            </div>
                                            
                                            <div class="form-group col-md-6">

                                                <label for="municipio">Municipio: </label>
                                                <s:set value="BeanFiscalia.municipio.idMunicipio" var="idMunicipio"/>
                                                <select class="form-control" name="BeanFiscalia.municipio.idMunicipio">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <s:set value="BeanFiscalia.persona.idPersona" var="idPersona"/>
                                                <select class="form-control" name="BeanFiscalia.persona.idPersona">
