                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary"> VERIFICA EL CORREO QUE SE ENVIÓ A TU CUENTA ELECTRÓNICA / <a href="Inicio.jsp" class="alert-danger">Regresar a inicio</a></h6>
                            </div>
                            <div class="card-body">
