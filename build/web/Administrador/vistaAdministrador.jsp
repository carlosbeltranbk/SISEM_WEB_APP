...
Created on : 8/03/2019, 06:18:42 PM
Author     : BELTRAN PC
--%>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Bienvenido, Carlos Beltrán</span>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#f41c1c"> SISEM </h6>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12" class="col-md-6" class="col-md-3">
                                    <center><img src="img/TJA_LOGO.png" class="img-responsive" alt="titulo"/></center>
                                    <div class="h-30"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <center><h5 class="modal-title" id="exampleModalLabel">SISEM</h5></center>
