<%-- 
    ...
    Created on : 8/03/2019, 08:48:14 PM
    Author     : BELTRAN PC
--%>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Usuario a modificar:</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="modificarUsuario" method="POST">
                                    <div class="form-row">
                                        ...
                                        <input  value="<s:property value="BeanUsuario.idUsuario"/>" type="hidden" class="form-control" name="BeanUsuario.idUsuario" />
                                        <div class="form-group col-md-3">
                                            <label for="correo">Correo del usuario: </label>
                                            <input value="<s:property value="BeanUsuario.correo"/>" type="email" class="form-control" id="correo" name="BeanUsuario.correo" >
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="contrasenia">Contraseña del usuario </label>
                                            <input value="<s:property value="BeanUsuario.contrasenia"/>" disabled type="password" class="form-control" id="contrasenia" name="BeanUsuario.contrasenia" >
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="persona">Usuario de la persona: </label>
                                            <s:set value="BeanUsuario.persona.idPersona" var="idPersona"/>
                                            <select class="form-control" name="BeanUsuario.persona.idPersona">
                                                <s:iterator value="listaPersonas" status="stat" var="lista">
                                                    <s:set value="idPersona" var="listaPersonasLista" />
                                                    <s:if test="{#idPersona} == {#listaPersonasLista}">
                                                        <option value="<s:property value="idPersona"/>" selected="" ><s:property value="nombre"/> <s:property value="primeroApellido"/> <s:property value="segundoApellido"/></option>
                                                    </s:if>
                                                    <s:else>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <s:set value="BeanUsuario.rol.idRol" var="idRol"/>
                                            <select class="form-control" name="BeanUsuario.rol.idRol">
                                                <s:iterator value="listaRoles" status="stat" var="lista">
                                                    <s:set value="idRol" var="listaRolesLista" />
                                                    <s:if test="{#idRol} == {#listaRolesLista}">
                                        ...
                                        <div class="form-group col-md-6">
                                            <s:set value="BeanUsuario.estado" var="est"/>
                                            <label for="estado">Estado </label>
                                            <select class="form-control" name="BeanUsuario.estado">
                                                <s:if test="%{#est == true}">
                                                    <option value="true" selected="">Activo</option>
                                                    <option value="false">Inactiva</option>
                                                </s:if>
                                                <s:elseif test="%{#est == false}">
                                        ...
                                        <div class="form-group col-md-6">
                                            <button onclick="return confirmarModificar()" type="submit" class="btn btn-outline-warning">Modificar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
                                                ...
                                                $("#btnAL_2").click(function () {
                                                    alertify.alert('Alert Título', 'Alert Mensaje!', function () {
                                                        alertify.success('Ok');
                                                    });
                                                });
                                                //Alertify .prompt
                                                $("#btnAL_3").click(function () {
                                                    alertify.prompt('Prompt Título', 'Prompt Mensaje', 'Ingrese un Valor'
                                                            , function (evt, value) {
                                                                alertify.success('Ingresaste: ' + value)
                                                            }
                                                    , function () {
                                                ...
                                                $("#btnAL_4").click(function () {
                                                    alertify.confirm('Mensaje de confirmación', function () {
                                                        alertify.success('Ok')
                                                    }, function () {
                                                        alertify.error('Cancel')
                                                    });
