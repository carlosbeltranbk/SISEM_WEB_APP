                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Integrante de Oficialia de Partes a modificar:</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="modificarOficialia" method="POST">
                                        <div class="form-row">

                                            <input  value="<s:property value="beanOficialia.persona.idPersona"/>" type="hidden" class="form-control" name="beanOficialia.persona.idPersona" />
                                            
                                            <div class="form-group col-md-6">

                                                <label for="rol">Rol: </label>
                                                <s:set value="beanOficialia.rol.idRol" var="idRol"/>
                                                <select disabled class="form-control" name="beanOficialia.rol.idRol">
                                                    <s:iterator value="listaRoles" status="stat" var="lista">
                                                        <s:set value="idRol" var="listaRolLista" />
                                                        <s:if test="{#idRol} == {#listaRolLista}">
                                                            <option value="<s:property value="idRol"/>" selected="" ><s:property value="nombreRol"/></option>
                                                        </s:if>
                                                        <s:else>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input value="<s:property value="beanOficialia.persona.nombre"/>" type="text" class="form-control" id="nombre" name="beanOficialia.persona.nombre" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="primeroApellido">Apellido Paterno: </label>
                                                <input value="<s:property value="beanOficialia.persona.primeroApellido"/>" type="text" class="form-control" id="primeroApellido" name="beanOficialia.persona.primeroApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="segundoApellido">Apellido Materno: </label>
                                                <input value="<s:property value="beanOficialia.persona.segundoApellido"/>" type="text" class="form-control" id="segundoApellido" name="beanOficialia.persona.segundoApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="fechaNacimiento">Fecha de Nacimineto: </label>
                                                <input title="Debes ser mayor de edad" required data-date-format="aaaa/mm/dd" min="1000-01-01" max="2001-12-31" value="<s:property value="beanOficialia.persona.fechaNacimiento"/>" type="date" class="form-control" id="fechaNacimiento" name="beanOficialia.persona.fechaNacimiento" >
                                                
                                            </div>

                                            <div  class="form-group col-md-3">
                                                <label for="edad">Edad: </label>
                                                <input value="<s:property value="beanOficialia.persona.edad"/>" type="text" disabled class="form-control" id="edad" name="beanOficialia.persona.edad" >                             
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="curp">Curp: </label>
                                                <input value="<s:property value="beanOficialia.persona.curp"/>" type="text" class="form-control" id="curp" name="beanOficialia.persona.curp" >

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="numeroTrabajador">Número de trabajador  </label>
                                                <input value="<s:property value="beanOficialia.persona.numeroTrabajador"/>"  class="form-control" id="numeroTrabajador" name="beanOficialia.persona.numeroTrabajador" >
                                            </div>

                                            <div class="form-group col-md-6">

                                                <label for="municipio">Municipio: </label>
                                                <s:set value="beanOficialia.municipio.idMunicipio" var="idMunicipio"/>
                                                <select class="form-control" name="beanOficialia.municipio.idMunicipio">
