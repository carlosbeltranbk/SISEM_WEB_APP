<%-- 
    Document   : Audiencias
    Created on : 10/03/2019, 04:59:02 PM
    Author     : BELTRAN PC
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Demandas de personas registradas</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="datos" width="100%" cellspacing="0">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Estado de la demanda</th>
                                                <th>Folio de la Demanda</th>
                                                <th>Nombre de la Persona</th>
                                                <th>Primer Apellido de la Persona</th>
                                                <th>Segundo Apellido de la Persona</th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
                                        ...
                                        <tbody>
                                            <s:iterator value="listaPersonaDemanas" status="stat" var="lista">
                                                <tr>
                                                    ...
                                                    <td alt="sin folio"><s:property value="idDemanda.folio"/></td>
                                                    <td><s:property value="idPersona.nombre"/></td>
                                                    <td><s:property value="idPersona.primeroApellido"/></td>
                                                    <td><s:property value="idPersona.segundoApellido"/></td>      
                                                </tr>
                                            </s:iterator>
                                        </tbody>
