                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Lista de integrantes de la Secretaria de Estudio y Cuenta: </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaSecretarias" status="stat" var="lista">
                                                <tr>
                                                    ...
                                                    <td><s:property value="persona.edad"/></td> 
                                                    <td><s:property value="persona.curp"/></td>
                                                    <td><s:property value="persona.numeroTrabajador"/></td> 
                                                    <td><s:property value="municipio.nombreMunicipio"/></td>
                                                  

                                                    <td>
                                                        <a class="btn btn-outline-success" href="<%=context%>/consultarSecretariaId?beanSecretaria.persona.idPersona=<s:property value="persona.idPersona"/>">Modificar</a>
                                                    </td>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
