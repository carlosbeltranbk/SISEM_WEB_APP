            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <p class="mb-4">Dentro de esta ventana se encuentra el formulario correspondiente para registrar
                            a una nueva persona. <a target="_blank" href="https://datatables.net">CodeSoft</a>.</p>

                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 style="color:#f41c1c">Persona a registrar:</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="registrarPersona" method="POST">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input  type="text" class="form-control" id="nombre" name="BeanPersona.nombre" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="primeroApellido">Primer Apellido: </label>
                                                <input  type="text" class="form-control" id="primeroApellido" name="BeanPersona.primeroApellido" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="segundoApellido">Segundo Apellido: </label>
                                                <input  type="text" class="form-control" id="segundoApellido" name="BeanPersona.segundoApellido" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="fechaNacimiento">Fecha Nacimineto: </label>
                                                <input type="text" class="form-control" id="fechaNacimiento" name="BeanPersona.fechaNacimiento" >
                                                <h6 class="text-warning">Formato: (AAAA-MM-DD)</h6>
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="curp">Curp: </label>
                                                <input  type="text" class="form-control" id="curp" name="BeanPersona.curp" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="numeroTrabajador">Número de trabajador:  </label>
                                                <input   class="form-control" id="numeroTrabajador" name="BeanPersona.numeroTrabajador" >
                                                <h6 class="text-warning">*Sólo Síndico Municipal (4 dígitos)</h6>
                                            </div>
                                            ...
                                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                <strong>Importante!</strong> Una vez registrada la persona, deberás registrar su
                                                usuario con el rol correspondiente.
