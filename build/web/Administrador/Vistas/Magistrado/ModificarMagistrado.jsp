                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Magistrado a modificar:</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="modificarMagistrado" method="POST">
                                        <div class="form-row">

                                            <input  value="<s:property value="beanMagistrado.persona.idPersona"/>" type="hidden" class="form-control" name="beanMagistrado.persona.idPersona" />
                                            
                                            <div class="form-group col-md-6">

                                                <label for="rol">Rol: </label>
                                                <s:set value="beanMagistrado.rol.idRol" var="idRol"/>
                                                <select disabled class="form-control" name="beanMagistrado.rol.idRol">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input value="<s:property value="beanMagistrado.persona.nombre"/>" type="text" class="form-control" id="nombre" name="beanMagistrado.persona.nombre" >
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="primeroApellido">Apellido Paterno: </label>
                                                <input value="<s:property value="beanMagistrado.persona.primeroApellido"/>" type="text" class="form-control" id="primeroApellido" name="beanMagistrado.persona.primeroApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="segundoApellido">Apellido Materno: </label>
                                                <input value="<s:property value="beanMagistrado.persona.segundoApellido"/>" type="text" class="form-control" id="segundoApellido" name="beanMagistrado.persona.segundoApellido" >
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="fechaNacimiento">Fecha de Nacimineto: </label>
                                                <input title="Debes ser mayor de edad" required data-date-format="aaaa/mm/dd" min="1000-01-01" max="2001-12-31" value="<s:property value="beanMagistrado.persona.fechaNacimiento"/>" type="date" class="form-control" id="fechaNacimiento" name="beanMagistrado.persona.fechaNacimiento" >
                                                
                                            </div>

                                            <div  class="form-group col-md-3">
                                                <label for="edad">Edad: </label>
                                                <input value="<s:property value="beanMagistrado.persona.edad"/>" type="text" disabled class="form-control" id="edad" name="beanMagistrado.persona.edad" >                             
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="curp">Curp: </label>
                                                <input value="<s:property value="beanMagistrado.persona.curp"/>" type="text" class="form-control" id="curp" name="beanMagistrado.persona.curp" >

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="numeroTrabajador">Número de trabajador  </label>
                                                <input value="<s:property value="beanMagistrado.persona.numeroTrabajador"/>"  class="form-control" id="numeroTrabajador" name="beanMagistrado.persona.numeroTrabajador" >
                                            </div>

                                            <div class="form-group col-md-6">

                                                <label for="municipio">Municipio: </label>
                                                <s:set value="beanMagistrado.municipio.idMunicipio" var="idMunicipio"/>
                                                <select class="form-control" name="beanMagistrado.municipio.idMunicipio">
