                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Fisclías Registradas</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <s:iterator value="listaFiscalias" status="stat" var="lista">
                                                <tr>
                                                    <td><s:property value="#stat.count"/></td>
                                                    <td><s:property value="nombreFiscalia"/></td>
                                                    <td><s:property value="direccionFiscalia"/></td>
                                                    <td><s:property value="municipio.nombreMunicipio"/></td>
                                                    <td><s:property value="persona.nombre"/></td>
        
                                                    <td>
                                                        <form action="eliminarFiscalia" method="POST">
                                                            <input type="hidden" name="BeanFiscalia.idFiscalia" value="<s:property value="idFiscalia"/>">
                                                            <input onclick="return confirmarEliminar()" class="btn btn-outline-danger" type="submit" value="Eliminar">
                                                        </form>
                                                    </td>

                                                    <td>
                                                        <a class="btn btn-outline-success" href="<%=context%>/consultarFiscaliaId?BeanFiscalia.idFiscalia=<s:property value="idFiscalia"/>">Modificar</a>
                                                    </td>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
